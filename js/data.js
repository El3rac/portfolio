...
const PROFILE = {
  ...
  // OPTIONNEL : affiche un formulaire de contact en bas de page (nom, email, Discord,
  // description du projet), envoyé directement dans ta boîte mail. Laisse "" pour ne
  // pas l'afficher (seuls les liens Email/YouTube/Instagram resteront visibles).
  // Clé gratuite sans inscription : va sur https://web3forms.com, entre ton email,
  // tu reçois la clé par mail en quelques secondes. Voir le README pour le détail.
  web3formsAccessKey: "a635162a-6604-4af0-9b31-bf795b8c8130",
};
...
/* =========================================================================
   ...
   - Pour réordonner : change simplement l'ordre des blocs dans le tableau.
     L'ordre ici définit aussi l'ordre du carrousel "clients" sur l'accueil
     et celui des filtres sur la page Projets.
   ...
   - La section "Quelques exemples de vidéos" de l'accueil se remplit toute
     seule (si une clé API YouTube est configurée) : la vidéo la plus vue de
     chaque chaîne + toutes les vidéos publiées il y a moins de 30 jours.
     Recalculé automatiquement à chaque rafraîchissement des vues, rien à faire.
   - Le nombre de vidéos/chaînes affiché dans la barre de stats est calculé
     automatiquement à partir de ce fichier : rien à faire de plus.
   ========================================================================= */
...
const CATEGORIES = [
  ...
  },
  {
    ...
    videos: [
      ...
      { youtubeId: "NqPgb7V-Zwo", roles: ["Script", "Montage", "Réalisation"] },
    ],
  },
  {
    name: "Melanchromia",
  ...
  },
  {
    ...
    description: "Chaîne personnelle qui traite de sujets cinéma.",
    videos: [
